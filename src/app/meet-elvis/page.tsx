  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Elvis Lossa is a U.S. Army combat veteran, father, and public servant running for Congress in Texas’ 31st District.",
            affiliation: {
              "@type": "Organization",
      ...
      <div className="max-w-4xl space-y-6">
        <PageHeading>Meet Elvis Lossa</PageHeading>
        ...
        <p className="text-lg dark:text-gray-300">
          ...
          Most recently, I served as Policy Coordinator for the Texas Speaker of the House,
          working on complex policy and operational challenges that affect communities
          across our state.
        </p>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <div className="text-base">
                  The job is about people, not ambition.
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <div className="text-base">
                  Promises mean nothing without results.
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <div className="text-base">
                  Policies should make life easier, not harder.
                </div>
              </div>
            </div>
          </li>
        ...
        <p className="text-lg dark:text-gray-300">
          Too often, leadership in Congress is focused on noise instead of outcomes.
          Families, veterans, and small businesses deserve representation that listens
          carefully and then acts decisively.
        </p>

        <p className="text-lg dark:text-gray-300">
          I am running for Congress to bring experience, accountability, and a
          results-driven approach to serving Central Texas.
        </p>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-1 text-lg text-gray-700 dark:text-gray-300 max-w-prose">
            <p className="mb-0">
              Elvis Lossa served as a U.S. Army soldier and combat veteran before
              committing his career to public service.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            <div className="overflow-hidden rounded-xl">
              <Image
                src="/afganistan.jpeg"
                alt="Elvis Lossa serving in Afghanistan"
                width={1200}
                height={800}
